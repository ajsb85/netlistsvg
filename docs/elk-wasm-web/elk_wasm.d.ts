...
export interface InitOutput {
    ...
    readonly __wbg_elk_free: (a: number, b: number) => void;
    readonly elk_knownLayoutAlgorithms: (a: number) => [number, number];
    readonly elk_knownLayoutCategories: (a: number) => [number, number];
    readonly elk_knownLayoutOptions: (a: number) => [number, number];
    readonly elk_layout: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
    readonly elk_new: () => number;
